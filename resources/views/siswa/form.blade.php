...
<!-- Content Header (Page header) -->
    ...
    @include('templates/feedback')
      ...
      <div class="box-header with-border">
          <a href="{{ url('siswa') }}" class="btn bg-purple"><i class="fa fa-chevron-left"> Kembali</i></a>
        </div>
        ...
        <div class="form-group">
		 ...
		 <div class="form-group">
          <label class="control-label col-sm-2">Nama Telpon</label>
          <div class="col-sm-10">
              <input type="text" name="no_telp" class="form-control" 
              placeholder="Masukkan No Telpon" value="{{@$result->no_telp}}">
          </div>
         </div>  
